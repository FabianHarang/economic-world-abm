...
export function PathChart({
  ...
  caption = "Inflation path from the deterministic Milestone 9 browser companion. This remains a stylized architecture run, not a calibrated Norway/EU result.",
  multiplier = 100,
  floor = 0,
  ceiling = 4,
  variant = "teal"
